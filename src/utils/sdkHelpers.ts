...
export const getAdditionalHeaderConfig = ({
  thoughtSpotHost,
  additionalHeaders,
}) => {
    ...
    promiseMiddleware: [
      {
        pre: (request: RequestContext) => {
          alert("ehre");
          request.setHeaderParam("X-Custom-Header", "your-custom-value");
          request.setHeaderParam("X-Client-Version", "1.0.0");
